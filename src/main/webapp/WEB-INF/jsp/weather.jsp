...
<html>
    ...
    <body>
        <form name="weather_form" action="weather" method="post">
            ...
            <br>
            <div style="display:none;" id="weather_showtable_div">
            <table id="weather_showtable" cellpadding=6  frame=box  >
                <thead>
                    <tr > 
                        <th>City</th> 
                        <th>State</th> 
                        <th>Country</th> 
                        <th>Local Current Time</th> 
                        <th>Temperature (F)</th> 
                        <th>Latitude</th> 
                        <th>Longitude</th> 
                        <th>Elevation</th> 
          ...
          <div style="display:none;" id="month_weather_showtable_div">
             ...
             <div style="display:none;" id="month_weather_showtable_new_div">
             <table id="month_weather_showtable_new" cellpadding=6 rules=groups  frame=box>
                <thead>
                   <tr>
                        <th>Month</th> 
                        <th>Min Avg Temp(F)</th> 
                ...
                <tbody id="temperatureMonthtbody_new">
                </tbody>
            </table>
            </div>
        </form>
	...
	function populateTableForWeatherByCity(responsetxt) {
				...
				for (var i=0;i<12;i++) {
				 ...
				 document.getElementById("month_weather_showtable_new_div").style.display = 'block';		
				 
				 $("#temperaturecitytbody").html(row);
				 $("#temperatureMonthtbody_new").html(monthData);
				 document.getElementById("month_weather_showtable_div").style.display = 'none';		
				 document.getElementById("month_weather_showtable").style.display = 'none';		
